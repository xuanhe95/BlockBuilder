...
public class AddPillarToPillar : MonoBehaviour
{
    public static string upPrefabPath = "Assets/Prefabs/Model/Pillar";
    public static string folderPath = "Assets/Prefabs/Model/Pillar"; // 文件夹路径

    [MenuItem("Custom/Add Pillar to Pillar")]
    private static void GetScriptsFromPrefabs()
    {
        ...
        foreach (string prefabPath in prefabPaths)
        {
            ...
            if (prefab != null)
            {
                ...
                {
                    prefab.GetComponent<RuleCreator>().Up.Add(addPrefab);
